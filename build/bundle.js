...
function startTroubleshooter() {
  ...
  if (this.audio) {
    var audioTest = new _defaultTests.AudioTest(mediaOptions, function (err, logs) {
      _this.setProperties({
      ...
      _this.troubleshootingLog.push(logs);
    });
...
var AdvancedCameraTest = function (_Test) {
  ...
  _createClass(AdvancedCameraTest, [{
    ...
    value: function runNextTest() {
      ...
      this.tests[testNum].run(function (results) {
        _this2.log.push(results);
        _this2.runNextTest(++testNum);
      });
    }
  }, {
    key: 'destroy',
